...
public class PasswordDialogFragment extends DialogFragment {
    ...
    public PasswordDialogFragment(EventCallback callback) {
        ...
        builder.setView(dialogView)
                .setPositiveButton(R.string.action_pwd_dialog_OK, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.SAVE_PASSWORD, pwd));
                    }
                })
                .setNegativeButton(R.string.action_pwd_dialog_cancel, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.SAVE_PASSWORD));
                    }
