...
public class FormattingController implements View.OnClickListener {
    ...
    public FormattingController(MainActivity context, EventCallback callback) {
        mContext = context;
        mCallback = callback;
    ...
    public void onClick(View view) {
        ...
        if (buttonId == R.id.button_insertFormatListBullets) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:DefaultBullet"));
        } else if (buttonId == R.id.button_insertFormatListNumbering) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:DefaultNumbering"));
        } else if (buttonId == R.id.button_increaseIndent) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:IncrementIndent"));
        } else if (buttonId == R.id.button_decreaseIndent) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:DecrementIndent"));
        } else if (buttonId == R.id.button_bold) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:Bold"));
        } else if (buttonId == R.id.button_italic) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:Italic"));
        } else if (buttonId == R.id.button_strikethrough) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:Strikeout"));
        } else if (buttonId == R.id.button_clearformatting) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:ResetAttributes"));
        } else if (buttonId == R.id.button_underlined) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:UnderlineDouble"));
        } else if (buttonId == R.id.button_align_left) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:LeftPara"));
        } else if (buttonId == R.id.button_align_center) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:CenterPara"));
        } else if (buttonId == R.id.button_align_right) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:RightPara"));
        } else if (buttonId == R.id.button_align_justify) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:JustifyPara"));
        } else if (buttonId == R.id.button_insert_line) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:Line"));
        } else if (buttonId == R.id.button_insert_rect) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:Rect"));
        } else if (buttonId == R.id.button_font_shrink) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:Shrink"));
        } else if (buttonId == R.id.button_font_grow) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:Grow"));
        } else if (buttonId == R.id.button_subscript) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:SubScript"));
        }else if (buttonId == R.id.button_superscript) {
            if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:SuperScript"));
        ...
        insertTableBuilder.setPositiveButton(R.string.alert_ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                try {
                    ...
                    if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:InsertTable",params.toString()));
        ...
        insertBuilder.setPositiveButton(R.string.alert_ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (selectedItem[0]){
                    case 0:
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:InsertRowsBefore"));
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.DOCUMENT_CHANGED));
                        break;
                    case 1:
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:InsertRowsAfter"));
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.DOCUMENT_CHANGED));
                        break;
                    case 2:
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:InsertColumnsBefore"));
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.DOCUMENT_CHANGED));
                        break;
                    case 3:
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:InsertColumnsAfter"));
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.DOCUMENT_CHANGED));
                        break;
                    case 4:
    ...
    private void deleteTable() {
        ...
        deleteBuilder.setPositiveButton(R.string.alert_ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (selectedItem[0]){
                    case 0:
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:DeleteRows"));
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.DOCUMENT_CHANGED));
                        break;
                    case 1:
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:DeleteColumns"));
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.DOCUMENT_CHANGED));
                        break;
                    case 2:
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:DeleteTable"));
                        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.DOCUMENT_CHANGED));
                        break;
                }
            }
    ...
    private void sendInsertGraphic() {
        ...
        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.UNO_COMMAND, ".uno:InsertGraphic", rootJson.toString()));
        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.REFRESH));
        if(mCallback != null)mCallback.queueEvent(new LOEvent(LOEvent.DOCUMENT_CHANGED));
    }
