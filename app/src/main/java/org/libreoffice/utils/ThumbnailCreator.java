...
public class ThumbnailCreator {
    ...
    public void createThumbnail(int partNumber, ImageView imageView, EventCallback callback) {
        if (needsThumbnailCreation(partNumber, imageView)) {
            ...
            if(callback != null)callback.queueEvent(new LOEvent(LOEvent.THUMBNAIL, task));
        }
    }
