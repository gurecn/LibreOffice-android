...
public class DocumentPartViewListAdapter extends ArrayAdapter<DocumentPartView> {
    ...
    public DocumentPartViewListAdapter(Activity activity, int resource, List<DocumentPartView> objects, EventCallback callback) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        thumbnailCollector.createThumbnail(position, imageView, mCallback);
